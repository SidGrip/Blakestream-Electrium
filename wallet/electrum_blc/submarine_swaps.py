...
API_URL_MAINNET = 'https://swaps.electrum-blc.org/api'
API_URL_TESTNET = 'https://swaps.electrum-blc.org/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain BLC, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        limits = pairs['pairs']['BLC/BLC']['limits']
