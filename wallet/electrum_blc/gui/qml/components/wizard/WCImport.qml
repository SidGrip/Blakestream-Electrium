...
WizardComponent {
    ...
    ColumnLayout {
        ...
        Label { text: qsTr('Import Blakecoin Addresses') }

        InfoTextArea {
            Layout.preferredWidth: parent.width
            text: qsTr('Enter a list of Blakecoin addresses (this will create a watching-only wallet), or a list of private keys.')
        }
