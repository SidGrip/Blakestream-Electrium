...
from electrum_blc.i18n import set_language, languages
from electrum_blc.plugin import run_hook
from electrum_blc.util import (profiler)
...
class ElectrumGui(Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app.engine.load('electrum_blc/gui/qml/components/main.qml')
