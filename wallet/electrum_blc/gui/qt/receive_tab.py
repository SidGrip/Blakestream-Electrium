...
from electrum_blc.bitcoin import is_address
from electrum_blc.i18n import _
from electrum_blc.util import InvoiceError
from electrum_blc.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING
from electrum_blc.invoices import PR_EXPIRED, pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = ''.join([
            ...
            _('The blakecoin address never expires and will always be part of this electrum wallet.'), ' ',
            _('You can reuse a blakecoin address any number of times but it is not good for your privacy.'),
            '\n\n',
        ...
        self.receive_tabs.addTab(self.receive_address_widget, read_QIcon("electrum-blc.png"), _('Address'))
