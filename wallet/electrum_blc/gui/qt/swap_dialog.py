...
from electrum_blc.util import NotEnoughFunds, NoDynamicFeeEstimates
from electrum_blc.lnutil import ln_dummy_address
from electrum_blc.transaction import PartialTxOutput, PartialTransaction
...
class SwapDialog(WindowModalDialog):
    ...
    def update(self):
        ...
        send_icon = read_QIcon("lightning.png" if self.is_reverse else "electrum-blc.png")
        self.send_label.setIcon(send_icon)
        recv_icon = read_QIcon("lightning.png" if not self.is_reverse else "electrum-blc.png")
