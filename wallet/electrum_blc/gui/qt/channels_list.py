...
from electrum_blc.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_blc.i18n import _
from electrum_blc.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState, ChanCloseOption
from electrum_blc.wallet import Abstract_Wallet
from electrum_blc.lnutil import LOCAL, REMOTE, format_short_channel_id
from electrum_blc.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def get_toolbar(self):
        ...
        # Blakecoin: disable swap for now
