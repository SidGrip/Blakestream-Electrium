...
from electrum_blc import util, paymentrequest
from electrum_blc import lnutil
from electrum_blc.plugin import run_hook
from electrum_blc.i18n import _
from electrum_blc.util import (get_asyncio_loop, bh2u, FailedToParsePaymentIdentifier,
...
from electrum_blc.transaction import Transaction, PartialTxInput, PartialTransaction, PartialTxOutput
from electrum_blc.network import TxBroadcastError, BestEffortRequestFailed
...
class SendTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = (_("Recipient of the funds.") + "\n\n"
               + _("You may enter a Blakecoin address, a label from your list of contacts "
                   "(a list of completions will be proposed), "
                   "or an alias (email-like address that forwards to a Blakecoin address)") + ". "
    ...
    def check_send_tab_onchain_outputs_and_show_errors(self, outputs: List[PartialTxOutput]) -> bool:
        ...
        for o in outputs:
            if o.scriptpubkey is None:
                self.show_error(_('Blakecoin Address is None'))
                return True
            if o.value is None:
