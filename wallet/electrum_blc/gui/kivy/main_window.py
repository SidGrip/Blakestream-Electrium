...
from electrum_blc.storage import WalletStorage, StorageReadWriteError
from electrum_blc.wallet_db import WalletDB
from electrum_blc.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet

from electrum_blc.plugin import run_hook
from electrum_blc import util
from electrum_blc.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                               format_satoshis, format_satoshis_plain, format_fee_satoshis,
                               parse_max_spend)
from electrum_blc.util import EventListener, event_listener
from electrum_blc.invoices import PR_PAID, PR_FAILED, Invoice
from electrum_blc import blockchain
from electrum_blc.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_blc.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
from electrum_blc.logging import Logger
from electrum_blc.bitcoin import COIN
...
#Factory.register('InstallWizard', module='electrum_blc.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_blc.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_blc.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_blc.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_blc_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_blc.gui.kivy.uix.screens')
...
from electrum_blc.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_blc.plugin import Plugins
    from electrum_blc.paymentrequest import PaymentRequest
...
class ElectrumWindow(App, Logger, EventListener):
    ...
    def scan_qr_non_android(self, on_complete):
        from electrum_blc import qrscanner
        try:
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_blc.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_blc.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_blc_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_blc_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-blc.png"
    ...
    def get_max_amount(self):
        from electrum_blc.transaction import PartialTxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-BLC', message,
                            app_icon=icon, app_name='Electrum-BLC')
        except ImportError:
