...
from electrum_blc.util import InvalidPassword
from electrum_blc.address_synchronizer import TX_HEIGHT_LOCAL
from electrum_blc.wallet import CannotBumpFee, CannotCPFP, CannotDoubleSpendTx
from electrum_blc.transaction import Transaction, PartialTransaction
from electrum_blc.network import NetworkException

from electrum_blc.gui.kivy.i18n import _
from electrum_blc.gui.kivy.util import address_colors
...
Builder.load_string('''
#:import KIVY_GUI_PATH electrum_blc.gui.kivy.KIVY_GUI_PATH
