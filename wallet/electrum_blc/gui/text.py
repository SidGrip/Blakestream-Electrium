...
from electrum_blc.gui import BaseElectrumGui
from electrum_blc import util
from electrum_blc.util import format_satoshis, format_time
from electrum_blc.util import EventListener, event_listener
from electrum_blc.bitcoin import is_address, address_to_script, COIN
from electrum_blc.transaction import PartialTxOutput
from electrum_blc.wallet import Wallet, Abstract_Wallet
from electrum_blc.wallet_db import WalletDB
from electrum_blc.storage import WalletStorage
from electrum_blc.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_blc.interface import ServerAddr
from electrum_blc.invoices import Invoice
from electrum_blc.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING

if TYPE_CHECKING:
    from electrum_blc.daemon import Daemon
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-blc create'")
            exit()
