...
from electrum_blc import WalletStorage, Wallet
from electrum_blc.wallet import Abstract_Wallet
from electrum_blc.wallet_db import WalletDB
from electrum_blc.util import format_satoshis, EventListener, event_listener
from electrum_blc.bitcoin import is_address, COIN
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Blakecoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-blc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-blc setconfig' to change your settings")
        return True
