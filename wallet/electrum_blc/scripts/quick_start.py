...
from electrum_blc.wallet import Wallet, create_new_wallet
from electrum_blc.wallet_db import WalletDB
from electrum_blc.commands import Commands
from electrum_blc.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-blc/testnet as datadir
