...
import electrum_blc.trampoline
from electrum_blc import bitcoin
from electrum_blc import util
from electrum_blc import constants
from electrum_blc.network import Network
from electrum_blc.ecc import ECPrivkey
from electrum_blc import simple_config, lnutil
from electrum_blc.lnaddr import lnencode, LnAddr, lndecode
from electrum_blc.bitcoin import COIN, sha256
from electrum_blc.util import bh2u, NetworkRetryManager, bfh, OldTaskGroup, EventListener
from electrum_blc.lnpeer import Peer
from electrum_blc.lnutil import LNPeerAddr, Keypair, privkey_to_pubkey
from electrum_blc.lnutil import PaymentFailure, LnFeatures, HTLCOwner
from electrum_blc.lnchannel import ChannelState, PeerState, Channel
from electrum_blc.lnrouter import LNPathFinder, PathEdge, LNPathInconsistent
from electrum_blc.channel_db import ChannelDB
from electrum_blc.lnworker import LNWallet, NoPathFound
from electrum_blc.lnmsg import encode_msg, decode_msg
from electrum_blc import lnmsg
from electrum_blc.logging import console_stderr_handler, Logger
from electrum_blc.lnworker import PaymentInfo, RECEIVED
from electrum_blc.lnonion import OnionFailureCode
from electrum_blc.lnutil import derive_payment_secret_from_payment_preimage, UpdateAddHtlc
from electrum_blc.lnutil import LOCAL, REMOTE
from electrum_blc.invoices import PR_PAID, PR_UNPAID
from electrum_blc.interface import GracefulDisconnect
    ...
    def test_reestablish_replay_messages_rev_then_sig(self):
        ...
        async def f():
            ...
            async with OldTaskGroup() as group:
                await group.spawn(p1._message_loop())
                await group.spawn(p2._message_loop())
                with self.assertLogs('electrum_blc', level='INFO') as logs:
