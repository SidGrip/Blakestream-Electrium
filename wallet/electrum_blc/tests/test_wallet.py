...
from electrum_blc.wallet_db import FINAL_SEED_VERSION
from electrum_blc.wallet import (Abstract_Wallet, Standard_Wallet, create_new_wallet,
                                 restore_wallet_from_text, Imported_Wallet, Wallet)
from electrum_blc.exchange_rate import ExchangeBase, FxThread
from electrum_blc.util import TxMinedInfo, InvalidPassword
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    def test_restore_wallet_from_text_xkey_that_is_also_a_valid_electrum_seed_by_chance(self):
        ...
        self.assertEqual('4CFGfsyckcSbCu4qsYDDDMw8vdpRnZhCf8', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_privkeys(self):
        ...
        self.assertEqual('blc1q2ccr34wzep58d4239tl3x3734ttle92awnp77g', addr0)
