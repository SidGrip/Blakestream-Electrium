...
from electrum_blc.crypto import sha256d, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_blc.bitcoin import public_key_to_p2pkh
from electrum_blc.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_blc import ecc
from electrum_blc.ecc import msg_magic
from electrum_blc.wallet import Standard_Wallet
from electrum_blc import constants
from electrum_blc.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_blc.i18n import _
from electrum_blc.keystore import Hardware_KeyStore
from electrum_blc.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_blc.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_blc.network import Network
from electrum_blc.logging import get_logger
from electrum_blc.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-BLC-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
