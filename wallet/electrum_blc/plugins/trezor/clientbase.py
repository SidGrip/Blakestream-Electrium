...
from electrum_blc.util import UserCancelled, UserFacingException
from electrum_blc.keystore import bip39_normalize_passphrase
...
from electrum_blc.plugin import runs_in_hwd_thread
from electrum_blc.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the blakecoins in the wallet.").format(self.device)
        else:
