...
from electrum_blc import ecc, constants
from electrum_blc import bip32
from electrum_blc.crypto import hash_160
from electrum_blc.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
from electrum_blc.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
from electrum_blc.i18n import _
from electrum_blc.keystore import Hardware_KeyStore
from electrum_blc.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_blc.wallet import Standard_Wallet
from electrum_blc.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_blc.base_wizard import ScriptTypeNotSupported
from electrum_blc.logging import get_logger
from electrum_blc.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Blakecoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Blakecoin mode")) from e
                raise e
