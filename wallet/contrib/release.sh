...
# - WWW_DIR: path to "electrum-blc-web" git clone
#
...
# - update locale:
#     1. cd /opt/electrum-blc-locale && ./update && push
...
VERSION=$(python3 -c "import electrum_blc; print(electrum_blc.version.ELECTRUM_VERSION)")
...
# create tarball
tarball="Electrum-BLC-$VERSION.tar.gz"
...
srctarball="Electrum-BLC-sourceonly-$VERSION.tar.gz"
...
# appimage
appimage="electrum-blc-$REV-x86_64.AppImage"
...
# windows
win1="electrum-blc-$REV.exe"
win2="electrum-blc-$REV-portable.exe"
win3="electrum-blc-$REV-setup.exe"
...
# android
apk1="Electrum-BLC-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-BLC-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-BLC-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-BLC-$VERSION.0-arm64-v8a-release-unsigned.apk"
