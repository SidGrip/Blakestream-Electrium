...
# defaults:
#   export APP_PACKAGE_NAME=Electrum-BLC
#   export APP_PACKAGE_DOMAIN=org.electrum_blc
...
#export APP_PACKAGE_DOMAIN=org.electrum_blc.testnet
...
if [[ "$3" == "release" ]] ; then
    ...
    export P4A_RELEASE_KEYALIAS=electrum_blc
    ...
    export P4A_DEBUG_KEYALIAS=electrum_blc
