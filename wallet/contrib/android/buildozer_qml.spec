...
package.domain = org.electrum_blc
...
version.filename = %(source.dir)s/electrum_blc/version.py
...
presplash.filename = %(source.dir)s/electrum_blc/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_blc/gui/icons/android_electrum_icon_legacy.png
icon.adaptive_foreground.filename = %(source.dir)s/electrum_blc/gui/icons/android_electrum_icon_foreground.png
icon.adaptive_background.filename = %(source.dir)s/electrum_blc/gui/icons/android_electrum_icon_background.png
...
android.add_src = electrum_blc/gui/kivy/data/java-classes/

android.gradle_dependencies = me.dm7.barcodescanner:zxing:1.9.8

android.add_activities = org.electrum_blc.qr.SimpleScannerActivity
