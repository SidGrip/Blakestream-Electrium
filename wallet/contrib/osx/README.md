...
This guide explains how to build Electrum-BLC binaries for macOS systems.
...
- The unix username should be `vagrant`, and `electrum-blc` should be cloned directly
  to the user's home dir: `/Users/vagrant/electrum-blc`.
...
#### 2. Build Electrum-BLC

    cd electrum-blc
    ./contrib/osx/make_osx.sh

This creates both a folder named Electrum-BLC.app and the .dmg file.
